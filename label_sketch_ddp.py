...
class NoisyCLIP(LightningModule):
    def __init__(self, args, text_labels):
        ...
        if self.hparams.baseclip_type == 'RN101':
            embed_size = 512
        elif self.hparams.baseclip_type == 'RN50':
            embed_size = 1024
        else:
        ...
        self.clean_visual_encoder = clip.load(self.hparams.baseclip_type, self.hparams.device, jit=False)[0].visual
        ...
        baseclip = clip.load(self.hparams.baseclip_type, self.hparams.device, jit=False)[0]
        baseclip.eval()
        ...
        for p in self.extra_layer.parameters():
    ...
    def configure_optimizers(self):
        ...
        num_steps = 95000 // (self.hparams.batch_size * self.hparams.gpus) #divide N_train by number of distributed iters
