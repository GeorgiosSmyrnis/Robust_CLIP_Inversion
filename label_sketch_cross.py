...
class NoisyCLIP(LightningModule):
    ...
    def forward(self, images):
        ...
        if self.hyparams.sketch_size == 'None':
            ...
            out = torch.matmul(label_sketch, self.random_on_clean.weight.to(label_sketch.device)) # Note that this is not accurate beyond top-1!

        return out

    def loss_clean_noisy(self, images_clean, images_noisy, labels):
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        train_loss = self.loss_clean_noisy(images_clean, images_noisy, labels)
    ...
    def validation_step(self, test_batch, batch_idx):
        ...
        val_loss = self.loss_clean_noisy(images_clean, images_noisy, labels)
    ...
    def test_step(self, test_batch, batch_idx):
        images_clean, images_noisy, labels = test_batch
        test_loss = self.loss_clean_noisy(images_clean, images_noisy, labels)
